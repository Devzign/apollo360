...
enum APIEndpoint {
    ...
    static func patientRecords(for patientId: String) -> String {
        "v1/patients/\(patientId)"
    }
    static func patientVisitSummary(for patientId: String, encounterId: Int) -> String {
        "v1/patients/\(patientId)/io-summary/\(encounterId)"
    }
